...
> **Superseded(2026-08-22)**:本文档已被《Rhiza 技术架构设计书 V4.0》取代(其绝大部分设计被继承并收敛),不再是架构权威,仅作 Historical Evidence 保留。现行基线:`docs/Rhiza_技术架构设计书_V4.0_20260822.md`。

> 副标题：事件驱动工作图谱与可移植运行时  
> 文档状态：目标架构基线 / 可施工设计（已废止）  
> 日期：2026-08-18  
